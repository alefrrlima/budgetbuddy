               ...
               <div className="itemsContainer">
                  ...
                  <div className="displayedItems">
                     <div className="displayedItem">
                        <span className="displayedItemQuantity">01</span>
